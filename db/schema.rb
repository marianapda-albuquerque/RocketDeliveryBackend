...
ActiveRecord::Schema[7.0].define(version: 2023_04_06_135211) do
  ...
  create_table "customers", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_customers_on_user_id", unique: true, where: "user_id IS NOT NULL"
  end
